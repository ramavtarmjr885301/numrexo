...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/construction/flooring-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Flooring Calculator", item: "https://numrexo.com/construction/flooring-calculator" },
    ],
});
