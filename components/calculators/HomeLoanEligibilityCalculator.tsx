...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/finance/home-loan-eligibility-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Home Loan Eligibility Calculator", item: "https://numrexo.com/finance/home-loan-eligibility-calculator" },
    ],
});
