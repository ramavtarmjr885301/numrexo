...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/education/weighted-grade-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Weighted Grade Calculator", item: "https://numrexo.com/education/weighted-grade-calculator" },
    ],
});
