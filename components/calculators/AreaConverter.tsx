...
const FAQ_DATA = [
    ...
    {
        q: "How many square feet are in a Bigha?",
        a: "A Bigha varies by state in India, ranging from roughly 6,000 to 27,000 square feet. In Uttar Pradesh, 1 Bigha is commonly taken as 27,000 square feet (approximately 0.62 acres), while in Punjab and Haryana it is closer to 9,070 square feet. Always confirm the local state definition before finalising a property deal.",
    },
    {
        q: "What is a Gaj and how does it relate to square feet?",
        a: "A Gaj is equivalent to 1 square yard, which equals 9 square feet. It is widely used in North Indian states like Delhi, Haryana, and Punjab for residential plot measurements. For example, a 200 Gaj plot equals 1,800 square feet.",
    },
    {
        q: "How do I convert carpet area to square meters?",
        a: "Carpet area is simply the usable floor area and converts the same way as any area unit. If your carpet area is given in square feet, multiply by 0.092903 to get square meters. For example, 1,000 sq ft of carpet area equals 92.9 square meters.",
    },
    {
        q: "Why do real estate listings use different area units?",
        a: "Different regions and countries have historically used different measurement systems. India often mixes metric (square meters), imperial (square feet), and traditional local units (Bigha, Gaj, Guntha, Cent) depending on the state and whether the property is urban or agricultural land. Converting to a single standard unit helps compare properties accurately.",
    },
];
...
export default function AreaConverter() {
    ...
    useEffect(() => { convert(); }, [value, fromUnit, toUnit, value, fromUnit, toUnit]);
        ...
        <>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-[#111827] border border-gray-800 rounded-xl p-5">
                        ...
                        <p className="text-gray-400 text-xs leading-relaxed">
                            ...
                            decimal-based and easy to scale — 1 hectare is exactly 10,000 square meters, with no
                    ...
                    <div className="bg-[#111827] border border-gray-800 rounded-xl p-5">
                        ...
                        <p className="text-gray-400 text-xs leading-relaxed">
                            ...
                            could plough with a yoke of oxen in a single day, and it remains the standard unit for
                            agricultural and residential land in the US, UK, and much of India&apos;s real estate market.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section aria-labelledby="use-cases" className="mb-8">
                ...
                <ul className="space-y-3">
                    {[
                        {
                            title: "Real Estate & Property Buying",
                            desc: "Property listings across India and abroad use different units — square feet in metros, Gaj in Delhi/NCR, Bigha in rural belts, and square meters in international listings. Converting to one unit lets you compare apples to apples before making a purchase decision.",
                        },
                        {
                            title: "Construction & Interior Design",
                            desc: "Estimating flooring tiles, paint, wallpaper, or carpet requires accurate area figures. Contractors often quote material requirements in square meters while suppliers sell by square feet, making conversion essential to avoid over- or under-ordering.",
                        },
                        {
                            title: "Agriculture & Land Records",
                            desc: "Farmers and land record offices frequently work in traditional units like Bigha, Guntha, or acres. Converting these to standard metric units is necessary when applying for loans, insurance, or government subsidy schemes that require standardised documentation.",
                        },
                        {
                            title: "Academic & Scientific Use",
