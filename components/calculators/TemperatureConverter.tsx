...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/conversion/temperature-converter",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Temperature Converter", item: "https://numrexo.com/conversion/temperature-converter" },
    ],
});
