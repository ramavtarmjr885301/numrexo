...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/math/decimal-to-fraction-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Decimal to Fraction Calculator", item: "https://numrexo.com/math/decimal-to-fraction-calculator" },
    ],
});
