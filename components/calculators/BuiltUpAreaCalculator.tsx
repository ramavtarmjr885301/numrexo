...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/construction/built-up-area-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Built-up Area Calculator", item: "https://numrexo.com/construction/built-up-area-calculator" },
    ],
});
