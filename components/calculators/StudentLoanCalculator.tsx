...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://www.numrexo.com/education/student-loan-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Student Loan Calculator", item: "https://www.numrexo.com/education/student-loan-calculator" },
    ],
});
