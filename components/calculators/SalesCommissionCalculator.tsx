...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/business/sales-commission-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Sales Commission Calculator", item: "https://numrexo.com/business/sales-commission-calculator" },
    ],
});
