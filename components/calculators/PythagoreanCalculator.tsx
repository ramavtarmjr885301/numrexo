...
export default function PythagoreanCalculator() {
    ...
    return (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                <div className="bg-[#111827] border border-gray-800 rounded-xl overflow-hidden">
                    ...
                    <div className="p-6 space-y-4">
                        ...
                        {calcType === "hypotenuse" && (
                            <>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Side a (leg)</label><input type="number" placeholder="3" value={sideA} onChange={(e) => setSideA(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Side b (leg)</label><input type="number" placeholder="4" value={sideB} onChange={(e) => setSideB(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                            </>
                        )}

                        {calcType === "leg" && (
                            <>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Hypotenuse (c)</label><input type="number" placeholder="5" value={hypotenuse} onChange={(e) => setHypotenuse(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Known Leg (a or b)</label><input type="number" placeholder="3" value={sideA} onChange={(e) => setSideA(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                            </>
                        )}

                        {calcType === "check" && (
                            <>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Side a</label><input type="number" placeholder="3" value={sideA} onChange={(e) => setSideA(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Side b</label><input type="number" placeholder="4" value={sideB} onChange={(e) => setSideB(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                                <div><label className="block text-xs font-semibold text-gray-400 mb-2">Side c (largest)</label><input type="number" placeholder="5" value={hypotenuse} onChange={(e) => setHypotenuse(e.target.value)} className="w-full px-4 py-3 bg-[#0f1525] border border-gray-700 rounded-lg text-white" /></div>
                            </>
                        )}

                        <button onClick={calculate} className="w-full py-3 rounded-lg bg-gradient-to-r from-green-500 to-green-700 text-white font-semibold hover:shadow-lg transition-all">Calculate →</button>
                    </div>
                </div>
            ...
            <section className="mb-8"><h2 className="text-xl font-semibold text-white mb-3">About Pythagorean Theorem Calculator</h2><p className="text-gray-400 text-sm leading-relaxed">Calculate the hypotenuse or missing leg of any right triangle using the Pythagorean theorem. Perfect for students, carpenters, architects, and anyone working with triangles.</p></section>

            <section className="mb-8"><h2 className="text-xl font-semibold text-white mb-4">Formula</h2>
            ...
            <section className="mb-8"><h2 className="text-xl font-semibold text-white mb-4">Pythagorean Triples (Integer Solutions)</h2>
                <div className="bg-[#111827] border border-gray-800 rounded-xl overflow-hidden">
