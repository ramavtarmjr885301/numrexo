...
const WEBAPP_SCHEMA = JSON.stringify({
    ...
    url: "https://numrexo.com/construction/roofing-calculator",
...
const BREADCRUMB_SCHEMA = JSON.stringify({
    ...
    itemListElement: [
        ...
        { "@type": "ListItem", position: 3, name: "Roofing Calculator", item: "https://numrexo.com/construction/roofing-calculator" },
    ],
});
