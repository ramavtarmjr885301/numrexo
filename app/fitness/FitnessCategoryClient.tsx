...
// app/fitness/FitnessCategoryClient.tsx
//
// Client half of the fitness category page. It was previously app/fitness/page.tsx,
...
// The metadata now lives in app/fitness/page.tsx, which is a server component.

import { getCalculatorsByCategory } from '@/data/calculatorsRegistry';
import CalculatorCard from '@/components/common/CalculatorCard';

export default function FitnessCategoryClient() {
            ...
            <div className="px-4 sm:px-6 py-8 md:py-12 max-w-6xl mx-auto">
                ...
                <div className="mb-5 text-sm text-gray-500 text-center border-b border-gray-800 pb-3">
                    {calculators.length > 0 ? (
                        <>💪 <span className="font-semibold text-blue-400">{calculators.length}+ fitness calculators</span> available — all free to use</>
                    ) : (
