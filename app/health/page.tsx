...
export default function HealthCategoryPage() {
    ...
    const pageTitle = "Health Calculators: BMI, Pregnancy Due Date, Ovulation, Water Intake & More | Numrexo";
    const pageDescription = "Free health calculators for BMI, ideal weight, pregnancy due date, ovulation, water intake, body type, and more. Trusted by 200,000+ users worldwide. Instant results, no sign-up.";
    ...
    return (
        <>
            {/* SEO Meta Tags - Health Specific */}
            <Head>
                <title>{pageTitle}</title>
                <meta name="description" content={pageDescription} />
                <meta name="keywords" content="health calculators, BMI calculator, pregnancy due date calculator, ovulation calculator, ideal weight calculator, water intake calculator, body type calculator, health tools, wellness calculators" />
                ...
                <meta property="og:title" content="Health Calculators | BMI, Pregnancy Due Date, Ovulation & Wellness Tools" />
                ...
                <meta name="twitter:title" content="Health Calculators | Wellness Tools for Everyone" />
                <meta name="twitter:description" content="Free health calculators for BMI, pregnancy due date, ovulation, water intake & more. Trusted by 200,000+ users worldwide." />
            </Head>
