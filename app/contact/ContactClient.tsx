...
//
// Client half of the contact page. It was previously app/contact/page.tsx, which
// began with 374 lines of commented-out code followed by "use client" - so the
// page could never export metadata and inherited the site-wide default title.
// (The commented-out block was dropped in this move; git history still has it.)
