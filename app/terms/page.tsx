...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">1. Acceptance of Terms</h2>
...
//                     {/* 2. About Numrexo */}
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">2. About Numrexo</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">3. Use of Our Website</h2>
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">4. Calculator Accuracy Disclaimer</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">5. No Professional Advice</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">6. User Responsibility</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">7. Intellectual Property</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">8. Third-Party Services</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">9. Advertisements and Affiliate Disclosure</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">10. Website Availability</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">11. Limitation of Liability</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     {/* 12. Privacy */}
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">12. Privacy</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     {/* 13. Changes to Terms */}
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">13. Changes to Terms</h2>
//                         <p className="text-gray-300 leading-relaxed">
...
//                     {/* 14. Contact Us */}
//                     <div>
//                         <h2 className="text-xl font-bold mb-3 text-blue-400">14. Contact Us</h2>
//                         <p className="text-gray-300 leading-relaxed">
