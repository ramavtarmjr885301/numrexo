    ...
    return (
        <div className="px-6 py-12 max-w-6xl mx-auto">
            <div className="text-center mb-10">
                <h1 className="text-3xl md:text-4xl font-bold mb-3">Mathematics Calculators</h1>
                <p className="text-gray-400 max-w-2xl mx-auto">Calculate percentages, fractions, quadratic equations, and more. Perfect for students and professionals.</p>
            </div>
