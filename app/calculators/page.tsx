...
//             {/* Divider between cards and links */}
...
//                   <span className="px-4 bg-[#0F172A] text-sm text-gray-500">More Calculators</span>
//                 </div>
//               </div>
//             )}
//           </>
...
//         {/* Calculator Links List - Remaining calculators */}
//         {linkCalculators.length > 0 && (
...
//                 key={calc.id}
//                 onClick={() => router.push(calc.path)}
//                 className="group flex items-center justify-between p-4 bg-[#111827] hover:bg-[#1A2333] border border-gray-800 rounded-xl transition-all duration-200 hover:border-blue-500/50 hover:shadow-lg"
//               >
...
//                       {calc.name}
//                     </h3>
//                     <p className="text-xs text-gray-500 line-clamp-1">{calc.desc}</p>
//                   </div>
//                 </div>
...
//                     <h3 className="font-medium text-white group-hover:text-blue-400 transition-colors text-sm sm:text-base truncate">
//                       {calc.name}
//                     </h3>
//                     <p className="text-xs text-gray-500 truncate hidden sm:block">{calc.desc}</p>
//                   </div>
//                 </div>
  ...
  return (
    <section className="px-4 sm:px-6 py-8 sm:py-12 md:py-16">
      <div className="max-w-6xl mx-auto">
        ...
        {/* Calculator Links List - Remaining calculators - FIXED: 2 columns on mobile, keeping original horizontal layout */}
        {linkCalculators.length > 0 && (
