...
export default function InvestmentCategoryPage() {
    ...
    const pageTitle = "Investment Calculators: SIP, PPF, NPS, Lumpsum, FD, RD & More | Numrexo";
    const pageDescription = "Free investment calculators for SIP returns, PPF maturity, NPS corpus, lumpsum growth, FD interest, and RD planning. Trusted by 100,000+ investors worldwide. Plan your wealth journey today.";
    ...
    return (
        <>
            {/* SEO Meta Tags - Investment Specific */}
            <Head>
                <title>{pageTitle}</title>
                <meta name="description" content={pageDescription} />
                <meta name="keywords" content="investment calculators, SIP calculator, PPF calculator, NPS calculator, lumpsum calculator, FD calculator, RD calculator, mutual fund calculator, retirement calculator, wealth planning tools" />
                ...
                <meta property="og:title" content="Investment Calculators | SIP, PPF, NPS, Lumpsum & Wealth Tools" />
                ...
                <meta name="twitter:title" content="Investment Calculators | Plan Your Wealth Journey" />
                <meta name="twitter:description" content="Free investment calculators for SIP, PPF, NPS, lumpsum, and more. Trusted by 100,000+ investors worldwide." />
            </Head>
