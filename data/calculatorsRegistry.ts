...
export const CALCULATORS_REGISTRY: CalculatorType[] = [
  ...
  { id: "consumer-loan-emi", slug: "consumer-loan-emi-calculator", name: "Consumer Loan EMI Calculator", icon: "🛒", color: "#8b5cf6", bg: "rgba(139,92,246,0.1)", desc: "Calculate your monthly consumer loan EMI for durables, vehicles & electronics", tags: ["Loan", "Consumer", "Popular"], category: "finance", path: generatePath("finance", "consumer-loan-emi-calculator"), popularity: 86 },
  { id: "personal-loan-emi", slug: "personal-loan-emi-calculator", name: "Personal Loan EMI Calculator", icon: "💰", color: "#3b82f6", bg: "rgba(59,130,246,0.1)", desc: "Calculate your monthly personal loan EMI with interest breakdown", tags: ["Loan", "Popular"], category: "finance", path: generatePath("finance", "personal-loan-emi-calculator"), popularity: 94 },
  { id: "home-loan-emi", slug: "home-loan-emi-calculator", name: "Home Loan EMI Calculator", icon: "🏡", color: "#10b981", bg: "rgba(16,185,129,0.1)", desc: "Calculate your monthly home loan EMI with interest breakdown", tags: ["Home", "Mortgage", "Popular"], category: "finance", path: generatePath("finance", "home-loan-emi-calculator"), popularity: 97 },
  { id: "car-loan-emi", slug: "car-loan-emi-calculator", name: "Car Loan EMI Calculator", icon: "🚗", color: "#3b82f6", bg: "rgba(59,130,246,0.1)", desc: "Calculate your monthly car loan EMI with down payment analysis", tags: ["Vehicle", "Car", "Popular"], category: "finance", path: generatePath("finance", "car-loan-emi-calculator"), popularity: 93 },
  { id: "bike-loan-emi", slug: "bike-loan-emi-calculator", name: "Bike Loan EMI Calculator", icon: "🏍️", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", desc: "Calculate your monthly bike loan EMI with down payment analysis", tags: ["Vehicle", "Bike", "Two-Wheeler"], category: "finance", path: generatePath("finance", "bike-loan-emi-calculator"), popularity: 82 },
  { id: "home-loan-eligibility", slug: "home-loan-eligibility-calculator", name: "Home Loan Eligibility Calculator", icon: "🏠", color: "#8b5cf6", bg: "rgba(139,92,246,0.1)", desc: "Check how much home loan you can get based on your income & profile", tags: ["Home", "Eligibility", "Mortgage"], category: "finance", path: generatePath("finance", "home-loan-eligibility-calculator"), popularity: 84 },
  ...
  { id: "population", slug: "population-calculator", name: "Population Calculator", icon: "🧑‍🤝‍🧑", color: "#f59e0b", bg: "rgba(245,158,11,0.1)", desc: "Calculate population growth, density & doubling time", tags: ["Demographics", "Statistics"], category: "math", path: generatePath("math", "population-calculator"), popularity: 90 },
  ...
  { id: "invoice", slug: "invoice-generator", name: "Invoice Generator", icon: "📄", color: "#14b8a6", bg: "rgba(20,184,166,0.1)", desc: "Free invoice, any currency", tags: ["Business", "New"], category: "business", path: generatePath("business", "invoice-generator"), popularity: 70, isNew: true },
  { id: "gst-invoice", slug: "gst-invoice-generator", name: "GST Invoice Generator", icon: "🧾", color: "#0d9488", bg: "rgba(13,148,136,0.1)", desc: "India GST invoice with HSN", tags: ["Business", "India"], category: "business", path: generatePath("business", "gst-invoice-generator"), popularity: 60, isNew: true },
...
//   },
//   "population": {
//     intro: "Calculate population growth, doubling time, and population density with our free population calculator. Project future population sizes, understand demographic trends, and analyze population density for any region.",
//     formula: "Population Growth: P(t) = P₀ × (1 + r)^t | Doubling Time: T = 70 / r | Population Density: D = P / A | P₀ = Initial Population, r = Growth Rate, t = Time (years), P = Population, A = Land Area (km²)",
//     table: [
//       ["Growth Rate", "Interpretation", "Doubling Time", "Examples"],
//       ["Above 3%", "Very High Growth ★★★★★", "Under 23 years", "Some African nations, Yemen"],
//       ["2-3%", "High Growth ★★★★", "23-35 years", "India, Philippines, Nigeria"],
//       ["1-2%", "Moderate Growth ★★★", "35-70 years", "USA, Brazil, Indonesia"],
//       ["0-1%", "Low Growth ★★", "70+ years", "China, UK, France"],
//       ["0%", "Stable ★★", "Never", "Germany, Italy, Japan"],
//       ["Negative", "Declining ★", "N/A", "Russia, Greece, Portugal"],
//     ],
//     faqs: [],
//   },
//   "personal-loan-emi": {
//     intro: "Calculate your monthly personal loan EMI with interest breakdown. Plan your loan repayments, compare interest rates, and find the best loan tenure for your needs.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | P = Principal (Loan Amount), r = Monthly Interest Rate, n = Total Payments (months)",
//     table: [
//       ["Loan Amount (₹5L)", "Interest Rate", "Tenure (Months)", "Monthly EMI", "Total Interest"],
//       ["₹5,00,000", "10%", "36 Months", "₹16,134", "₹80,824"],
//       ["₹5,00,000", "12%", "36 Months", "₹16,607", "₹97,852"],
//       ["₹5,00,000", "14%", "36 Months", "₹17,096", "₹1,15,456"],
//       ["₹5,00,000", "12%", "24 Months", "₹23,537", "₹64,888"],
//       ["₹5,00,000", "12%", "48 Months", "₹13,166", "₹1,31,968"],
//       ["₹5,00,000", "12%", "60 Months", "₹11,122", "₹1,67,320"],
//     ],
//     faqs: [],
//   },
//   "consumer-loan-emi": {
//     intro: "Calculate your monthly consumer loan EMI for consumer durables, vehicles, electronics, and more. Plan your purchases and compare financing options with our free EMI calculator.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | P = Principal (Loan Amount), r = Monthly Interest Rate, n = Total Payments (months)",
//     table: [
//       ["Loan Type", "Amount", "Rate", "Tenure", "Monthly EMI", "Total Interest"],
//       ["Consumer Durable", "₹50,000", "14%", "12 Months", "₹4,490", "₹3,880"],
//       ["Consumer Durable", "₹50,000", "14%", "18 Months", "₹3,080", "₹5,440"],
//       ["Vehicle", "₹5,00,000", "10%", "48 Months", "₹12,680", "₹1,08,640"],
//       ["Vehicle", "₹5,00,000", "10%", "60 Months", "₹10,624", "₹1,37,440"],
//       ["Electronics", "₹1,00,000", "16%", "12 Months", "₹9,069", "₹8,828"],
//       ["Electronics", "₹1,00,000", "16%", "18 Months", "₹6,324", "₹13,832"],
//     ],
//     faqs: [],
//   },
//   "home-loan-emi": {
//     intro: "Calculate your monthly home loan EMI with our free calculator. Plan your dream home purchase, compare interest rates, and find the best loan tenure for your mortgage.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | P = Principal (Loan Amount), r = Monthly Interest Rate, n = Total Payments (months)",
//     table: [
//       ["Tenure", "EMI (₹50L, 9%)", "Total Interest", "Total Payment", "Best For"],
//       ["10 Years", "₹63,341", "₹26.01L", "₹76.01L", "Quick repayment"],
//       ["15 Years", "₹50,710", "₹41.28L", "₹91.28L", "Balance of both"],
//       ["20 Years", "₹44,986", "₹57.97L", "₹1,07.97L", "Lower monthly EMI"],
//       ["25 Years", "₹41,964", "₹75.89L", "₹1,25.89L", "Lowest EMI"],
//       ["30 Years", "₹40,230", "₹94.83L", "₹1,44.83L", "Minimum EMI"],
//     ],
//     faqs: [],
//   },
//   "car-loan-emi": {
//     intro: "Calculate your monthly car loan EMI with our free calculator. Plan your car purchase, compare interest rates for new and used cars, and find the best loan tenure for your dream car.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | P = Principal (Loan Amount), r = Monthly Interest Rate, n = Total Payments (months)",
//     table: [
//       ["Tenure", "EMI (₹8L, 9%)", "Total Interest", "Total Payment", "Best For"],
//       ["3 Years", "₹25,440", "₹1.16L", "₹9.16L", "Quick repayment"],
//       ["4 Years", "₹19,893", "₹1.55L", "₹9.55L", "Balance of both"],
//       ["5 Years", "₹16,605", "₹1.96L", "₹9.96L", "Popular choice"],
//       ["6 Years", "₹14,418", "₹2.38L", "₹10.38L", "Lower EMI"],
//       ["7 Years", "₹12,857", "₹2.80L", "₹10.80L", "Minimum EMI"],
//     ],
//     faqs: [],
//   },
//   "bike-loan-emi": {
//     intro: "Calculate your monthly bike loan EMI with our free calculator. Plan your two-wheeler purchase, compare interest rates for new and used bikes, and find the best loan tenure for your dream bike.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | P = Principal (Loan Amount), r = Monthly Interest Rate, n = Total Payments (months)",
//     table: [
//       ["Tenure", "EMI (₹1L, 10%)", "Total Interest", "Total Payment", "Best For"],
//       ["12 Months", "₹8,790", "₹5,480", "₹1,05,480", "Quick repayment"],
//       ["18 Months", "₹6,002", "₹8,036", "₹1,08,036", "Balance of both"],
//       ["24 Months", "₹4,614", "₹10,736", "₹1,10,736", "Popular choice"],
//       ["36 Months", "₹3,226", "₹16,136", "₹1,16,136", "Lower EMI"],
//       ["48 Months", "₹2,535", "₹21,680", "₹1,21,680", "Minimum EMI"],
//     ],
//     faqs: [],
//   },
//   "home-loan-eligibility": {
//     intro: "Check your home loan eligibility with our free calculator. Find out how much loan you can get based on your income, age, existing obligations, and property value.",
//     formula: "Eligible Loan = (Monthly Income × FOIR - Existing EMI) × ((1+r)^n - 1) / (r × (1+r)^n) | FOIR = Fixed Obligation to Income Ratio, r = Monthly Interest Rate, n = Tenure (months)",
//     table: [
//       ["Income", "Eligible Amount (20Y, 9%)", "Monthly EMI", "EMI Ratio"],
//       ["₹30,000", "₹22.5 Lakhs", "₹20,243", "67.5%"],
//       ["₹50,000", "₹45 Lakhs", "₹40,487", "81.0%"],
//       ["₹75,000", "₹72 Lakhs", "₹64,780", "86.4%"],
//       ["₹1,00,000", "₹1.2 Crore", "₹1,07,974", "108.0%"],
//       ["₹1,50,000", "₹1.8 Crore", "₹1,61,961", "108.0%"],
//     ],
//     faqs: [],
//   },
//   "amortization": {
//     intro: "Generate a complete loan amortization schedule with our free calculator. See how your payments are split between principal and interest over the life of your loan.",
//     formula: "EMI = P × r × (1+r)^n / ((1+r)^n - 1) | Interest = Balance × r | Principal = EMI - Interest | New Balance = Balance - Principal",
//     table: [
//       ["Extra Payment", "Tenure Saved", "Interest Saved", "Total Savings"],
//       ["₹0", "0 months", "₹0", "₹0"],
//       ["₹1,000", "5 months", "₹43,212", "₹48,212"],
//       ["₹2,000", "10 months", "₹84,568", "₹94,568"],
//       ["₹5,000", "22 months", "₹1,87,432", "₹2,02,432"],
//       ["₹10,000", "38 months", "₹3,12,876", "₹3,42,876"],
//     ],
//     faqs: [],
//   },
//   "credit-score-estimator": {
//     intro: "Estimate your credit score range with our free calculator. Understand your creditworthiness based on payment history, credit utilization, and other key factors.",
//     formula: "Score = (Payment History × 35%) + (Credit Utilization × 30%) + (Credit History × 15%) + (Credit Mix × 10%) + (New Credit × 10%) | Then converted to 300-900 range",
//     table: [
//       ["Score Range", "Rating", "What It Means", "Recommended"],
//       ["750-900", "Excellent ★★★★★", "Best rates on loans", "✅ Keep maintaining"],
//       ["700-749", "Good ★★★★", "Competitive rates", "✅ Good to apply"],
//       ["650-699", "Fair ★★★", "Higher rates", "⚠️ Improve before applying"],
//       ["600-649", "Below Average ★★", "Difficult approval", "🔴 Build credit first"],
//       ["Below 600", "Poor ★", "Very limited options", "🔴 Urgent improvement"],
//     ],
//     faqs: [],
//   },
//   "loan-prepayment": {
//     intro: "Calculate how much you can save by prepaying your loan. See the impact of extra payments on your total interest and loan tenure with our free calculator.",
//     formula: "Interest Saved = Original Total Interest - New Total Interest | Tenure Reduced = Original Tenure - New Tenure | Break-even = Penalty / Monthly Savings",
//     table: [
