...
export const CALCULATORS_REGISTRY: CalculatorType[] = [
  ...
  {
    id: "consumer-loan-emi",
    slug: "consumer-loan-emi-calculator",
    name: "Consumer Loan EMI Calculator",
    icon: "🛒",
    color: "#8b5cf6",
    bg: "rgba(139,92,246,0.1)",
    desc: "Calculate your monthly consumer loan EMI for durables, vehicles & electronics",
    tags: ["Loan", "Consumer", "Popular"],
    category: "finance",
    path: generatePath("finance", "consumer-loan-emi-calculator"),
    popularity: 86
  },
  {
    ...
    desc: "Calculate your monthly personal loan EMI with interest breakdown",
    tags: ["Loan", "Popular"],
    category: "finance",
    path: generatePath("finance", "personal-loan-emi-calculator"),
    popularity: 94
  },
  {
    id: "home-loan-emi",
    ...
    desc: "Calculate your monthly home loan EMI with interest breakdown",
    tags: ["Home", "Mortgage", "Popular"],
    category: "finance",
    path: generatePath("finance", "home-loan-emi-calculator"),
    popularity: 97
  },
  {
    id: "car-loan-emi",
    ...
    color: "#3b82f6",
    bg: "rgba(59,130,246,0.1)",
    desc: "Calculate your monthly car loan EMI with down payment analysis",
    tags: ["Vehicle", "Car", "Popular"],
    category: "finance",
    path: generatePath("finance", "car-loan-emi-calculator"),
    popularity: 93
  },
  {
    id: "bike-loan-emi",
    ...
    desc: "Calculate your monthly bike loan EMI with down payment analysis",
    tags: ["Vehicle", "Bike", "Two-Wheeler"],
    category: "finance",
    path: generatePath("finance", "bike-loan-emi-calculator"),
    popularity: 82
  },
  {
    ...
    color: "#8b5cf6",
    bg: "rgba(139,92,246,0.1)",
    desc: "Check how much home loan you can get based on your income & profile",
    tags: ["Home", "Eligibility", "Mortgage"],
    category: "finance",
    path: generatePath("finance", "home-loan-eligibility-calculator"),
    popularity: 84
  },
  {
    id: "amortization",
    ...
    color: "#8b5cf6",
    bg: "rgba(139,92,246,0.1)",
    desc: "Generate complete loan amortization schedule with interest breakdown",
    tags: ["Loan", "Mortgage", "Schedule"],
    category: "finance",
    path: generatePath("finance", "amortization-calculator"),
    popularity: 79
  },
  {
    ...
    color: "#8b5cf6",
    bg: "rgba(139,92,246,0.1)",
    desc: "Estimate your credit score range based on key financial factors",
    tags: ["Credit", "Score", "Popular"],
    category: "finance",
    path: generatePath("finance", "credit-score-estimator"),
    popularity: 78
  },
  {
    id: "loan-prepayment",
    ...
    color: "#10b981",
    bg: "rgba(16,185,129,0.1)",
    desc: "Calculate interest savings from loan prepayment",
    tags: ["Loan", "Prepayment", "Savings"],
    category: "finance",
    path: generatePath("finance", "loan-prepayment-calculator"),
    popularity: 81
  },
  ...
  {
    id: "population",
    slug: "population-calculator",
    name: "Population Calculator",
    icon: "🧑‍🤝‍🧑",
    color: "#f59e0b",
    bg: "rgba(245,158,11,0.1)",
    desc: "Calculate population growth, density & doubling time",
    tags: ["Demographics", "Statistics"],
    category: "math",
    path: generatePath("math", "population-calculator"),
    popularity: 90
  },
